...
export class BFSPathFinder extends PathFinder {
    ...
    findPath(startNodeId: number, endNodeId: number): PathFinderResult {
        ...
        const previous: Map<Node<NodeDataType>, Node<NodeDataType>> = new Map<
            Node<NodeDataType>,
            Node<NodeDataType>
        >(); //this is for path reconstruction
    ...
    private reconstructPath(
        previous: Map<Node<NodeDataType>, Node<NodeDataType>>,
