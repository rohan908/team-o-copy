...
const teamMembers: Member[] = [
    {
        ...
        image: 'TeamPhotos/liam.png',
    },
    {
        name: 'Logan Winters',
        role: 'Product Owner',
        quote: '"Stay hard"',
        image: 'TeamPhotos/Logan.png',
    },
    {
        name: 'Hudson Kortus',
        role: 'Lead Software Engineer',
        quote: '"rm fr ./*"',
        image: 'TeamPhotos/Hudson.png',
    },
    {
        name: 'Rohan Inamdar',
        role: 'Assistant Lead Software Engineer',
        quote: '"I never recovered from the JD Honey"',
        image: 'TeamPhotos/Rohan.png',
    },
    {
        name: 'Owen Hart',
        role: 'Assistant Lead Software Engineer',
        quote: '"you\'re on the wong page"',
        image: 'TeamPhotos/Owen.png',
    },
    {
        name: 'Yanding Mario',
        role: 'Assistant Lead Software Engineer',
        quote: '"Yanding-Submit-Bug"',
        image: 'TeamPhotos/Yanding.png',
    },
    {
        name: 'Camden Brayton',
        ...
        image: 'TeamPhotos/Camden.png',
    },
    {
        name: 'Joseph Abata',
        role: 'Full-Time Software Engineer',
        quote: '“Git reset :(“',
        image: 'TeamPhotos/Joe.png',
    },
    {
        name: 'Connor Daly',
        role: 'Full-Time Software Engineer',
        quote: '"RIP PR-2447313140: by Mario-Runner, 2024-2024"',
        image: 'TeamPhotos/conner.png',
    },
    {
        name: 'Adam Blanchard',
        role: 'Scrum Master',
        quote: '"Give me empty quotes, I don\'t say anything"',
        image: 'TeamPhotos/Adam.png',
    },
    {
        name: 'Ethan Ramoth',
        role: 'Documentation',
