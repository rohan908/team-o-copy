...
const DirectionsBox = (props: Props) => {
    ...
    const speechText = steps.map((step) => parseHTMLtoText(step.instruction)).join('....');
                ...
                {(styles) => (
                    <div style={styles}>
                        ...
                        <Flex direction={'row'} gap="md" ta="center" mt="md" align={'center'}>
                            <Button
                                onClick={() => {
                                    navigate('/IndoorMapPage');
                                }}
                                color="secondaryBlues.5"
                                size="compact-sm"
                            >
                                See Hospital Map
                            </Button>
