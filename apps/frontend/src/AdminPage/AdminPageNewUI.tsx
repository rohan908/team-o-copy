                ...
                <Grid.Col span={'content'}>
                        ...
                        {(styles) => (
                            <div style={styles}>
                                <Flex direction="column" justify="center">
                                    <Box w="20vw" mih="100vh" p="lg" mt="-8px">
                                        <Flex direction="column" justify="center" gap="sm">
                                            ...
                                            >
                                                <Flex
                                                    ...
                                                    gap="sm"
                                                >
                                                    <Title c="black">Service Requests</Title>
                                                    <Collapse
                                                        in={formInfoOpen}
                                                ...
                                                <Flex
                                                    ...
                                                    gap="sm"
                                                >
                                                    <Title c="black">Other Tools</Title>
                                                    <Collapse
                                                        in={otherToolsOpen}
                                                        transitionDuration={0}
                                                        transitionTimingFunction="linear"
                    ...
                    {!sidebarOpen && (
                        <Transition mounted={!sidebarOpen} transition="slide-left" duration={400}>
                            {(styles) => (
                                <div style={styles}>
                                    <Box w="55px" h="100vh" p="lg" mt="-8px">
                                        <ActionIcon
                                            bg="#EBF2FF"
                                            size="input-sm"
                                            onClick={toggle}
